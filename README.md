2) there is a class with matrices and a class with a method that multiplies them. Then the class with the method "utils" displays the resulting matrix on the screen
